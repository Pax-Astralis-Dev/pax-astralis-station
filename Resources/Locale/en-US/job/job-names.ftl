job-name-warden = Security Sergeant NS-3
job-name-security = Security Officer NS-2
job-name-cadet = Security Cadet NS-1
job-name-hos = Sector Commander NS-5
...
job-name-hop = Sector Administrator
...
JobHeadOfPersonnel = Sector Administrator
...
JobSeniorOfficer = Security Lieutenant NS-4
