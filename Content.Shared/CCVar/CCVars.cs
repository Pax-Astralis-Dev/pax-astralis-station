...
namespace Content.Shared.CCVar
{
    ...
    public sealed class CCVars : CVars
    {
        ...
        public static readonly CVarDef<float>
            EventsRampingAverageEndTime = CVarDef.Create("events.ramping_average_end_time", 600f, CVar.ARCHIVE | CVar.SERVERONLY);
        ...
        /// </summary>
        public static readonly CVarDef<string>
            GameMap = CVarDef.Create("game.map", "Oreo", CVar.SERVERONLY);
